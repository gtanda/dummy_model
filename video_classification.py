...
Original file is located at
    https://colab.research.google.com/github/keras-team/keras-io/blob/master/examples/vision/ipynb/video_classification.ipynb
...
# Running prepvideos takes awhile, storing labels and data
# train_data, train_labels = prepare_all_videos(train_df, "train")
# np.save('./prepped_videos/train_data_labels.npy', train_labels)
# train_data_processed = np.array(train_data[0], dtype='object')
# np.save('./prepped_videos/train_data_values[0].npy', train_data_processed)
# train_data_processed = np.array(train_data[1], dtype='object')
# np.save('./prepped_videos/train_data_values[1].npy', train_data_processed)
#
# test_data, test_labels = prepare_all_videos(test_df, "test")
#
# np.save('./prepped_videos/test_data_labels.npy', test_labels)
# test_data_processed = np.array(test_data[0], dtype='object')
# np.save('./prepped_videos/test_data_values[0].npy', test_data_processed)
# test_data_processed = np.array(test_data[1], dtype='object')
# np.save('./prepped_videos/test_data_values[1].npy', test_data_processed)

train_data_zero = np.stack(np.load('./prepped_videos/train_data_values[0].npy', allow_pickle=True)).astype(np.float32)
train_data_one = np.stack(np.load('./prepped_videos/train_data_values[1].npy', allow_pickle=True)).astype(np.float32)
...
# Loading in labels and data
train_labels = np.stack(np.load('./prepped_videos/train_data_labels.npy', allow_pickle=True))
test_labels = np.stack(np.load('./prepped_videos/test_data_labels.npy', allow_pickle=True))

test_data_zero = np.stack(np.load('./prepped_videos/test_data_values[0].npy', allow_pickle=True)).astype(np.float32)
test_data_one = np.stack(np.load('./prepped_videos/test_data_values[1].npy', allow_pickle=True)).astype(np.float32)
test_data = [test_data_zero, test_data_one]


model_acc, model_val_acc = [], []
